...
public class SimpleAgedCacheTest {
    ...
    public void getExpired() {
        ...
        assertEquals(2, expired.size()); //Added to make sure .put works as expected
        clock.offset(Duration.ofMillis(3000));

        expired.get("aKey"); //My current implementation of .get is what removes the expired entry
